...
fdata <- as.data.frame(sapply(seed,gnorm))

colnames(fdata) <- c("x1","x2","z11","z12","z13","u")
# get z1 and z2
fdata <- mutate(fdata, z1 = sqrt(0.4)*z11+sqrt(0.6)*z12, z2 = sqrt(0.4)*z11 + sqrt(0.6)*z13)
# get the response data
fdata <- mutate(fdata, y = b0 + b1*x1 + b2*x2 + z1 + z2 + z1*z2 +u)
# -----------------------END-------------------------------------
